...
const Header = () => {
  ...
  return <header className="bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50 w-full border-b">
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className="bg-primary/10 p-2 rounded-lg">
            <img src="/lovable-uploads/55cd3d40-878c-46b7-8499-c69a292f216a.png" alt="Pressure Wash 901 Logo" className="h-8 w-auto" />
          </div>
        ...
        <div className="lg:hidden flex items-center space-x-2">
          <Button size="sm" className="bg-[var(--gradient-hero)] hover:bg-primary-hover text-gray-900">
            Quote
          </Button>
      ...
      {isMenuOpen && <div className="lg:hidden bg-background border-t">
          <div className="container py-4 space-y-4">
            ...
            <button onClick={() => scrollToSection('about')} className="block w-full text-left text-muted-foreground hover:text-primary transition-colors py-2">
              About Us
            </button>
